...
class Secciones_calidad extends CI_Controller {
    ...
    public function guardar()
    {
        ...
        if($error == 1){
            ...
            insertar_traza(fecha(), hora(), $this->session->id, 'secciones_calidad', 'Agregar', $texto, 0);
    ...
    public function eliminar($id)
    {
        ...
        if($delete === false){
            ...
            insertar_traza(fecha(), hora(), $this->session->id, 'secciones_calidad', 'Eliminar', $texto, 1, $id);
