...
class Registros_indicadores extends CI_Controller {
    ...
    public function __construct()
    {
        ...
        validate_session();
        $this->load->model('registros_indicadores_Model', 'registro_indicador');
    }
    ...
    {
        $data['indicadores'] = $this->registro_indicador->obtener_registros_indicadores();
        $this->load->view('layout/header');
        $this->load->view('registros_indicadores/index', $data);
    ...
    public function agregar()
    {
        ...
        $this->load->view('layout/header');
        $this->load->view('registros_indicadores/agregar', $data);
        $this->load->view('layout/footer');
    }
    ...
    public function editar($id)
    {
        ...
        $this->load->view('layout/header');
        $this->load->view('registros_indicadores/editar', $data);
        $this->load->view('layout/footer');
    }
