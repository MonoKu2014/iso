<div class="container-fluid">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?= base_url();?>calidad_incidencias">Registros de Incidencias</a></li>
    ...
    <div class="row">
        <div class="col-lg-12">
            <h2 class="page-header">
                ...
                <a href="<?= base_url(); ?>calidad_incidencias" class="btn btn-default pull-right">
    ...
    <div class="row">
        <div class="col-lg-12">
        <form method="post" action="<?= base_url(); ?>calidad_incidencias/guardar_edicion" class="form" enctype="multipart/form-data">
