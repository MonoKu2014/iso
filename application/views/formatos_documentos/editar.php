            ...
            <div class="col-xs-12 col-lg-10 col-lg-offset-1">
                ...
                <div class="col-xs-12 col-sm-6 col-md-9">
                    <div class="form-group">
                        <input type="text" name="formato_documento" data-validate="string" class="form-control required" placeholder="Formato Documento" required value="<?= $formato_documento->formato_documento; ?>">
                    </div>
                </div>
