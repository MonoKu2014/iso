            ...
            <div class="col-xs-12 col-lg-10 col-lg-offset-1">
                ...
                <div class="col-xs-12 col-sm-6 col-md-9">
                    <div class="form-group">
                        <input type="text" name="origen_incidencia" data-validate="string" class="form-control input-sm required" placeholder="Origen" required value="<?= $origen_incidencia->origen_incidencia; ?>">
                    </div>
                </div>
