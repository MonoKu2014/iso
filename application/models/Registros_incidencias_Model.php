...
class Registros_incidencias_Model extends CI_Model {
    ...
    public function obtener_registros_incidencias()
    {
    ...
    public function obtener_registro_incidencia($id)
    {
    ...
    public function eliminar($id)
    {
        ...
        return $this->db->delete('incidencias');
    }
