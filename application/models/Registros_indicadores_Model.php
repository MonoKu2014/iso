...
class Registros_indicadores_Model extends CI_Model {
    ...
    public function obtener_registros_indicadores()
    {
        ...
        $query = $this->db->get('registros_indicadores i');
        return $query->result();
    }
    ...
    {
        return $this->db->insert('registros_indicadores', $data);
    }

    public function eliminar($id)
    {
        $this->db->where('indicador_id', $id);
        return $this->db->delete('registros_indicadores');
    }
    ...
    {
        $this->db->where('indicador_id', $id);
        return $this->db->update('registros_indicadores', $data);
    }
